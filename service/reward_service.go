...
func ExecuteReward(id int64) error {
	...
	if err := AddDelayBill(tx, common.AccountNSure, reward.Currency, reward.Amount.Neg(), decimal.Zero,
		common.BillTypeReward, ""); err != nil {
		return err
	}
	if err := AddDelayBill(tx, reward.ArbiterId, reward.Currency, reward.Amount, decimal.Zero,
		common.BillTypeReward, ""); err != nil {
		return err
	}
	reward.Settled = true
...
func ExecuteRewardCha(id int64) error {
	...
	if err := AddDelayBill(tx, common.AccountChallenge, rewardCha.Currency, rewardCha.Amount.Neg(), decimal.Zero,
		common.BillTypeReward, ""); err != nil {
		return err
	}
	if err := AddDelayBill(tx, rewardCha.ChallengeId, rewardCha.Currency, rewardCha.Amount, decimal.Zero,
		common.BillTypeReward, ""); err != nil {
		return err
	}
